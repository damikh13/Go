...
1. Указывать 3-й индекс при копировании — s6 := s5[1:4:3] — взять элементы с 1-го индекса (вкл) по 4-й (невкл.) и ограничить cap = 3. Если его не указать, то cap будет: с 1-го индекса до конца массива.
